...
class CreateJobOrderHasStatusesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('job_order_has_statuses', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('job_order_has_statuses');
    }
}
