    ...
    <div class="col-md-6">
        <table style="width: 100%">
            <tbody>
                <tr>
                    <td colspan="5">
                        <h6 class="head-color">A. Pendapatan</h6>
                    </td>
                </tr>
                <tr>
                    <td>
                ...
                <tr>
                    ...
                    <td>
                        <span id="jumlah_uang_makan"></span>
                    </td>
                    <td>
                        <span> Hari</span>
                    </td>
                ...
                <tr>
                    <td colspan="5">
                        <h6 class="mt-4 head-color">B. Pemotongan</h6>
                    </td>
                </tr>
                <tr>
                    <td>
                ...
                <tr>
                    ...
                    <td>
                        <span id="nominal_potongan_lain_lain">
                            Rp
                        </span>
                    </td>
                </tr>
                ...
                <tr>
                    <td colspan="4">
                        <h6 class="mt-4 head-color">C. Gaji Bersih</h6>
                    </td>
                    <td>
                        <span id="gaji_bersih">
                            Rp
