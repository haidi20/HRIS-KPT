                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group row">
                                            <label for="after_work" class="col-sm-4 col-form-label">Jam Selesai
                                                Kerja</label>
                                            <div class="col-sm-8">
                                                <input type="time" id="after_work" name="after_work" class="form-control"
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group row">
                                            <label for="maximum_delay" class="col-sm-4 col-form-label">Jam Maksimal
                                                Keterlambatan</label>
                                            <div class="col-sm-8">
                                                <input type="time" id="maximum_delay" name="maximum_delay"
                                                    class="form-control" placeholder="contoh: 08:30"
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group row">
                                            <label for="fastest_time" class="col-sm-4 col-form-label">Jam Paling Cepat
                                                Pulang</label>
                                            <div class="col-sm-8">
                                                <input type="time" id="fastest_time" name="fastest_time"
                                                    class="form-control" placeholder="contoh: 16:30"
                                                    value="{{ $fastestTime[0] ?? '' }}">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group row">
                                            <label for="overtime_work" class="col-sm-4 col-form-label">Jam Mulai
                                                Lembur</label>
                                            <div class="col-sm-8">
                                                <input type="time" id="overtime_work" name="overtime_work"
                                                    class="form-control" placeholder="contoh: 16:30"
